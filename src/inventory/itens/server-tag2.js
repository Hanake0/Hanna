...
export default class TagN2 extends TemporaryItem {
	constructor(client, infos) {
		...
		if(client.readyAt) this.role = client.waifusClub.roles.cache.get(infos.roleID);
		else client.once('ready', () => this.role = client.waifusClub.roles.cache.get(infos.roleID));
	}
	...
	toFirestore() {
		return {
			_type: 'TagN2',
			_path: '../Inventário/Items/Misc/tag2.js',
