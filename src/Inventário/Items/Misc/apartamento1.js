...
export default class ApartamentoN1 extends TemporaryItem {
  constructor(client, infos) {
    super(client, {
      _userID: infos._userID,
      nome: 'Apartamento Nº1',
      type: 'misc',
    ...
    client.once('ready', () => this.channel = client.waifusClub.channels.cache.get(infos.channelID));
  }
