...
export default class GeradorDePalavrasCommand extends Command {
	constructor(client) {
		super(client, {
			name: 'gerador-de-palavras',
			aliases: ['palavra'],
			group: 'utilidades',
			memberName: 'gerador-de-palavras',
			clientPermissions: ['MANAGE_MESSAGES'],
			description: 'Gera uma palavra completamente randômica.',
			args: [
				{
					key: 'texto',
